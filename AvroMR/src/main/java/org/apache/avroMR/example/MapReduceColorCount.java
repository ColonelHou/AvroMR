...
package org.apache.avroMR.example;
...
import org.apache.avroMR.pojo.User;
...
public class MapReduceColorCount extends Configured implements Tool {
  ...
  public int run(String[] args) throws Exception {
    ...
    FileInputFormat.setInputPaths(job, new Path("hdfs://ip:9000/data/test/in/avr/users.avro"));
    FileOutputFormat.setOutputPath(job, new Path("hdfs://ip:9000/data/test/out/avr"));
